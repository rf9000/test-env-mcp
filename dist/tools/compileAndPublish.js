...
export const CompileAndPublishInputSchema = z
    ...
    schemaUpdateMode: z
        ...
        .optional()
        .default('synchronize')
        .describe('Schema update mode: synchronize (default) = safe update, recreate = drop+recreate tables, forcesync = force synchronization')
})
    .strict();
/**
 ...
 */
export async function executeCompileAndPublish(compilationService, input) {
    try {
        // Validate input
...
//# sourceMappingURL=compileAndPublish.js.map